...
python3 "$SCRIPTS_DIR/theme_extraction.py" --input "$DATA_DIR/synthetic_responses.json" --output "$DATA_DIR/theme_mapping_1.json"
...
python3 "$SCRIPTS_DIR/theme_variation.py" --input "$DATA_DIR/theme_mapping_1.json" --output "$DATA_DIR/theme_mapping_2.json" --variation "$VARIATION_LEVEL"
...
python3 "$SCRIPTS_DIR/theme_comparison.py" --mapping1 "$DATA_DIR/theme_mapping_1.json" --mapping2 "$DATA_DIR/theme_mapping_2.json" --output "$DATA_DIR/comparison_results.json" --summary "summary.md" --visualizations "$VISUALIZATIONS_DIR"
